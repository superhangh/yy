package com.yy.framework.web.config;
...
import com.yy.framework.web.core.filter.CacheRequestBodyFilter;
import com.yy.framework.web.core.filter.DemoFilter;
import com.yy.framework.web.core.handler.GlobalExceptionHandler;
import com.yy.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class YyWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "yy.demo", havingValue = "true")
