package com.yy.framework.ratelimiter.config;

import com.yy.framework.ratelimiter.core.aop.RateLimiterAspect;
import com.yy.framework.ratelimiter.core.keyresolver.RateLimiterKeyResolver;
import com.yy.framework.ratelimiter.core.keyresolver.impl.*;
import com.yy.framework.ratelimiter.core.redis.RateLimiterRedisDAO;
...
public class YyRateLimiterConfiguration {
