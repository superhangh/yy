package com.yy.framework.tenant.config;

import com.yy.framework.common.biz.system.tenant.TenantCommonApi;
import com.yy.framework.common.enums.WebFilterOrderEnum;
import com.yy.framework.mybatis.core.util.MyBatisUtils;
import com.yy.framework.redis.config.YyCacheProperties;
import com.yy.framework.security.core.service.SecurityFrameworkService;
import com.yy.framework.tenant.core.aop.TenantIgnore;
import com.yy.framework.tenant.core.aop.TenantIgnoreAspect;
import com.yy.framework.tenant.core.db.TenantDatabaseInterceptor;
import com.yy.framework.tenant.core.job.TenantJobAspect;
import com.yy.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import com.yy.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import com.yy.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import com.yy.framework.tenant.core.redis.TenantRedisCacheManager;
import com.yy.framework.tenant.core.security.TenantSecurityWebFilter;
import com.yy.framework.tenant.core.service.TenantFrameworkService;
import com.yy.framework.tenant.core.service.TenantFrameworkServiceImpl;
import com.yy.framework.tenant.core.web.TenantContextWebFilter;
import com.yy.framework.tenant.core.web.TenantVisitContextInterceptor;
...
import static com.yy.framework.common.util.collection.CollectionUtils.convertList;

@AutoConfiguration
@ConditionalOnProperty(prefix = "yy.tenant", value = "enable", matchIfMissing = true) // 允许使用 yy.tenant.enable=false 禁用多租户
@EnableConfigurationProperties(TenantProperties.class)
public class YyTenantAutoConfiguration {
    ...
    @ConditionalOnClass(name = "com.yy.framework.mq.redis.core.interceptor.RedisMessageInterceptor")
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     YyCacheProperties yyCacheProperties,
                                                     TenantProperties tenantProperties) {
        // 创建 RedisCacheWriter 对象
        RedisConnectionFactory connectionFactory = Objects.requireNonNull(redisTemplate.getConnectionFactory());
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(yyCacheProperties.getRedisScanBatchSize()));
    ...
    @Configuration(proxyBeanMethods = false)
    @ConditionalOnClass(name = "com.yy.framework.quartz.core.handler.JobHandler")
