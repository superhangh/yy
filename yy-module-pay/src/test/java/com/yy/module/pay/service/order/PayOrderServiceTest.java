package com.yy.module.pay.service.order;

import cn.hutool.extra.spring.SpringUtil;
import com.yy.framework.common.pojo.PageResult;
import com.yy.framework.test.core.ut.BaseDbAndRedisUnitTest;
import com.yy.module.pay.api.order.dto.PayOrderCreateReqDTO;
import com.yy.module.pay.controller.admin.order.vo.PayOrderExportReqVO;
import com.yy.module.pay.controller.admin.order.vo.PayOrderPageReqVO;
import com.yy.module.pay.controller.admin.order.vo.PayOrderSubmitReqVO;
import com.yy.module.pay.controller.admin.order.vo.PayOrderSubmitRespVO;
import com.yy.module.pay.dal.dataobject.app.PayAppDO;
import com.yy.module.pay.dal.dataobject.channel.PayChannelDO;
import com.yy.module.pay.dal.dataobject.order.PayOrderDO;
import com.yy.module.pay.dal.dataobject.order.PayOrderExtensionDO;
import com.yy.module.pay.dal.mysql.order.PayOrderExtensionMapper;
import com.yy.module.pay.dal.mysql.order.PayOrderMapper;
import com.yy.module.pay.dal.redis.no.PayNoRedisDAO;
import com.yy.module.pay.enums.PayChannelEnum;
import com.yy.module.pay.enums.notify.PayNotifyTypeEnum;
import com.yy.module.pay.enums.order.PayOrderStatusEnum;
import com.yy.module.pay.framework.pay.config.PayProperties;
import com.yy.module.pay.framework.pay.core.client.PayClient;
import com.yy.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO;
import com.yy.module.pay.framework.pay.core.enums.PayOrderDisplayModeEnum;
import com.yy.module.pay.service.app.PayAppService;
import com.yy.module.pay.service.channel.PayChannelService;
import com.yy.module.pay.service.notify.PayNotifyService;
...
import static com.yy.framework.common.util.date.LocalDateTimeUtils.*;
import static com.yy.framework.common.util.json.JsonUtils.toJsonString;
import static com.yy.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.yy.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.yy.framework.test.core.util.AssertUtils.assertServiceException;
import static com.yy.framework.test.core.util.RandomUtils.*;
import static com.yy.module.pay.enums.ErrorCodeConstants.*;
