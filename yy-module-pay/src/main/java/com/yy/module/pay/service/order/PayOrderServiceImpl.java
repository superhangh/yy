...
import com.yy.framework.common.util.number.MoneyUtils;
...
import com.yy.module.pay.framework.pay.core.client.dto.order.PayOrderUnifiedReqDTO;
import com.yy.framework.tenant.core.util.TenantUtils;
...
import com.yy.module.pay.convert.order.PayOrderConvert;
    ...
    public PayOrderSubmitRespVO submitOrder(PayOrderSubmitReqVO reqVO, String userIp) {
        ...
        if (unifiedOrderResp != null) {
            try {
                ...
                // 兼容 https://gitee.com/zhijiantianya/yy-cloud/issues/I8SM9H 场景
