...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.yy";
    private static final String ARTIFACT_ID = "yy";
    private static final String PACKAGE_NAME = "com.yy";
    private static final String TITLE = "yy派单系统";
