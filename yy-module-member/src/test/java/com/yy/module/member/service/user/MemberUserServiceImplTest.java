...
import com.yy.module.member.controller.app.user.vo.AppMemberUserUpdateMobileReqVO;
import com.yy.module.member.dal.dataobject.user.MemberUserDO;
import com.yy.module.member.dal.mysql.user.MemberUserMapper;
import com.yy.module.member.service.auth.MemberAuthServiceImpl;
 ...
 */
@Disabled
@Import({MemberUserServiceImpl.class, YyRedisAutoConfiguration.class})
