package com.yy.module.system.service.social;
...
import com.yy.framework.common.util.cache.CacheUtils;
import com.yy.framework.common.util.http.HttpUtils;
import com.yy.framework.common.util.object.BeanUtils;
import com.yy.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.yy.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
...
import com.yy.module.system.controller.admin.social.vo.client.SocialClientPageReqVO;
import com.yy.module.system.controller.admin.social.vo.client.SocialClientSaveReqVO;
import com.yy.module.system.dal.dataobject.social.SocialClientDO;
import com.yy.module.system.dal.mysql.social.SocialClientMapper;
import com.yy.module.system.dal.redis.RedisKeyConstants;
import com.yy.module.system.enums.social.SocialTypeEnum;
import com.yy.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.yy.framework.common.util.collection.MapUtils.findAndThen;
import static com.yy.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.yy.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${yy.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${yy.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/yy-cloud/pulls/230
